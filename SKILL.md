...
- **Yield Farming (`Kamino`)**: AI-guided analysis and vault selection for lending.
...
├── resources/
│   ├── ai-prompts.md               # Standardized Groq LLM prompts
│   └── spend-limits.md             # Security parameters & config
├── examples/
│   ├── money-glitch.md             # The autonomous loop logic
│   ├── meteora-liquidity.md        # Deep dive into DLMM spot strategies
│   └── orca-trading.md             # Setting up autonomous swappers
└── docs/
